...
| Documentación  | [Esquema de URIs](https://github.com/HerculesCRUE/ib-asio-docs-/blob/master/entregables_hito_1/08-Esquema_de_URIs_Hércules/ASIO_Izertis_ArquitecturaDeURIs.md)<br/>[Buenas practicas para URIs Hércules](https://github.com/HerculesCRUE/ib-asio-docs-/blob/master/entregables_hito_1/09-Buenas_prácticas_para_URIs_Hércules/ASIO_Izertis_BuenasPracticasParaURIsHercules.md)<br/>[Documentación técnica](./Documentación técnica.md) (documentación de bajo nivel)<br/>[Documentación API REST de la Factoria de URIs](./Documentación API REST de la Factoria de URIs.md) (documentación de bajo nivel)<br/>[build](./build.md)<br/>[docker](./docker.md) |



# Manual de usuario

El presente documento realiza una descripción de la Factoría de URIs a alto nivel, por lo tanto, se complementa con el documento de [Documentación tecnica](./Documentación técnica.md) que la describe a bajo nivel.
