...
/**
 * Filter for {@link CanonicalURILanguage}.
 */
@Getter
@Setter
@NoArgsConstructor
public class CanonicalURILanguageFilter extends AbstractJpaSpecification<CanonicalURILanguage> implements EntityFilter {
    ...
    @Override
    public Predicate toPredicate(final Root<CanonicalURILanguage> root, final CriteriaQuery<?> query,
