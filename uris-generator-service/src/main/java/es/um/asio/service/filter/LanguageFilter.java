...
/**
 * Filter for {@link Language}.
 */
@Getter
@Setter
@NoArgsConstructor
public class LanguageFilter extends AbstractJpaSpecification<Language> implements EntityFilter {
    ...
    @Override
    public Predicate toPredicate(final Root<Language> root, final CriteriaQuery<?> query,
