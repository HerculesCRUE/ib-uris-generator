...
/**
 * Filter for {@link CanonicalURI}.
 */
@Getter
@Setter
@NoArgsConstructor
public class CanonicalURIFilter extends AbstractJpaSpecification<CanonicalURI> implements EntityFilter {
    ...
    @Override
    public Predicate toPredicate(final Root<CanonicalURI> root, final CriteriaQuery<?> query,
