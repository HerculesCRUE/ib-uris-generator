...
@Setter
@NoArgsConstructor
public class LocalURIFilter extends AbstractJpaSpecification<LocalURI> implements EntityFilter {
    ...
    @Override
    public Predicate toPredicate(final Root<LocalURI> root, final CriteriaQuery<?> query,
